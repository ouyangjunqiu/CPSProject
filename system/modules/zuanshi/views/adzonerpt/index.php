    ...
    <div class="search-box">
                ...
                <div class="col-md-11">
                    <div class="com-list-tit" style="display: block;">
                        ...
                        <small>
                            ...
                            <a href="<?php echo $this->createUrl("/zuanshi/adzonerpt/index",array("nick"=>$query["nick"]));?>"><span class="label label-info">资源位优选</span></a>
        ...
        <div class="row" style="margin-top: 10px;margin-bottom: 10px;">
            <div class="col-md-11">
                ...
                <a href="<?php echo $this->createUrl("/zuanshi/adzonerpt/index",array("nick"=>$query["nick"],"orderby"=>"ctr"));?>">
                    <?php if($query["orderby"] == "ctr"):?><span class="label label-info"><?php else:?><span class="label label-default"><?php endif;?>点击率</span>
                </a>
                <a href="<?php echo $this->createUrl("/zuanshi/adzonerpt/index",array("nick"=>$query["nick"],"orderby"=>"charge"));?>">
                    <?php if($query["orderby"] == "charge"):?><span class="label label-info"><?php else:?><span class="label label-default"><?php endif;?>消耗</span>
                </a>
                <a href="<?php echo $this->createUrl("/zuanshi/adzonerpt/index",array("nick"=>$query["nick"],"orderby"=>"alipayInShopNum7"));?>">
...
<!--                <a class="btn btn-warning" href="--><?php //echo $this->createUrl("/zuanshi/down/more",array("nick"=>$query["nick"],"begin_date"=>$query['beginDate'],"end_date"=>$query['endDate']));?><!--" id="down-excel">下载</a>-->
        ...
        <table class="baby-frame-table" id="table_fixed" style="table-layout: fixed;">
            ...
            <?php if(empty($list)):?>
                <tr><td colspan="22">暂无资源位分析报表, 请在钻石展位后台使用精准平台小助手的"下载资源位报表"功能下载资源位报表!</td></tr>
            <?php else:?>
