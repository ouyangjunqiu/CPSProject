                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="babyinfor-interface">
                                ...
                                <a href="javascript:void(0);" class="chakanbaobiao" data-click="shoprpt" data-url="<?php echo Yii::app()->urlManager->createUrl('/tool/rpt/index',array("nick"=>$row["nick"]));?>" data-has-ztcrpt-href="<?php echo Yii::app()->urlManager->createUrl('/ztc/custrpt/hasget',array("nick"=>$row["nick"]));?>" data-ztcrpt-href="http://yj.da-mai.com/index.php?r=milestone/adviser/custreport&nick=<?php echo $row["nick"];?>" data-post-ztcrpt-href="<?php echo Yii::app()->urlManager->createUrl('/ztc/custrpt/source',array("nick"=>$row["nick"]));?>">直钻报表</a>
                            </div>
