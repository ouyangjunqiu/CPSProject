        ...
        <div class="shop-list-cont" id="shop-search">
            ...
            <div class="search-left com-list-tit" style="display: block;">
                ...
                <span class="shop-list-txt">智·钻</span><small>
                    <a href="<?php echo $this->createUrl("/zuanshi/dashboard/index");?>"><span class="label label-info">全店推广</span></a>
                    ...
                    <div class="baby-box" data-nick="<?php echo $row["nick"];?>" data-role="list">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="rpt_<?php echo $row["id"];?>">
                                <div class="row" data-tmpl="shop-zuanshirpt-list-tmpl" data-load="overlay" data-url="<?php echo $this->createUrl("/zuanshi/rpt/getbynick",array("nick"=>$row["nick"],"shopname"=>$row["shopname"]));?>">
                                </div>
