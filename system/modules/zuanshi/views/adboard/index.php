...
<div class="index-table-div">
    ...
    <div class="search-box">
                ...
                <div class="col-md-11">
                    <div class="com-list-tit" style="display: block;">
                        ...
                        <small>
                            ...
                            <a href="<?php echo $this->createUrl("/zuanshi/adboard/index",array("nick"=>$query["nick"]));?>"><span class="label label-info">创意优选</span></a>
        ...
        <div class="row" style="margin: 10px 0px;">
            <div class="col-md-11">
                <small>近7天统计报表:</small>
                <a href="<?php echo $this->createUrl("/zuanshi/adboard/index",array("nick"=>$query["nick"],"orderby"=>"ctr"));?>">
                    <?php if($query["orderby"] == "ctr"):?><span class="label label-info"><?php else:?><span class="label label-default"><?php endif;?>点击率</span>
                </a>
                <a href="<?php echo $this->createUrl("/zuanshi/adboard/index",array("nick"=>$query["nick"],"orderby"=>"charge"));?>">
                    <?php if($query["orderby"] == "charge"):?><span class="label label-info"><?php else:?><span class="label label-default"><?php endif;?>消耗</span>
                </a>
                <a href="<?php echo $this->createUrl("/zuanshi/adboard/index",array("nick"=>$query["nick"],"orderby"=>"alipayInShopNum7"));?>">
        ...
        <table class="table-frame" style="table-layout: fixed;">
            ...
            <?php if(empty($list)):?>
                <tr><td colspan="4">暂无创意分析报表, 请在钻石展位后台使用精准平台小助手的"下载创意报表"功能下载创意报表!</td></tr>
            <?php else:?>
