                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php echo empty($row["ztc_budget"])?"<span class=\"label label-warning\">直通车暂停</span>":"<span class=\"label label-info\">直通车推广</span>";?>
                                <?php echo empty($row["zuanshi_budget"])?"<span class=\"label label-warning\">智钻暂停</span>":"<span class=\"label label-info\">智钻推广</span>";?>
                                <?php
                                if(!empty($row["tags"])){
