<!-- 上传附件管理窗口 -->
<link rel="stylesheet" href="<?php echo STATICURL; ?>/js/app/dialogUpload/YJCloud.dialogUpload.css">
...
<script src="<?php echo STATICURL; ?>/js/app/dialogUpload/YJCloud.dialogUpload.js"></script>
<script>
	(function(){
