...
class ShopPayPctRpt extends Model
{
    /**
     * Returns the static model of the specified AR class.
     * @param string $className active record class name.
     * @return ShopPayPctRpt the static model class
     */
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('log_date,nick,userid,usernumid,shopid,shopname,pct,create_date', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('log_date,nick,userid,usernumid,shopid,shopname,pct,create_date', 'safe', 'on'=>'search'),
        );
    }
